...
NSString *EncryptKey = @"8daluqp9xm2kw6zs1hta";
...
{
    return [self encrypt:sText encryptOrDecrypt:kCCEncrypt key:EncryptKey];
}

+ (NSString *)decryptWithText:(NSString *)sText
{
    return [self encrypt:sText encryptOrDecrypt:kCCDecrypt key:EncryptKey];
}
